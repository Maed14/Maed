...
<head>
    ...
    <link rel="stylesheet" href="saved_event.css">
    <title>Your Liked Event</title>
</head>
...
<body>
    ...
    <?php
        ...
        $sql = "SELECT s.Save_Event_Id, s.Event_Id, e.Event_Title, e.Event_Location, e.Event_Time, e.Adult_Ticket, e.Event_Date
                FROM save_event s
    ...
    <div class="content">
        <div class="ordersheader">
            <h1 style="font-size: 40px; color: #FF5106;">Your Liked Event</h1>
        </div>
        ...
        <div class="order-list">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="order-item">
                    ...
                    <div class="details">
                        <a href="../Event_page/eventpage.php?id=<?php echo $row['Event_Id']; ?>">Details</a>
                    </div>
                </div>
                <?php
            }
